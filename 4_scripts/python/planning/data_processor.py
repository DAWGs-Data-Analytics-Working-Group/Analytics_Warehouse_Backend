...
for folder in [clear_folder, processed_traffic_email_folder,
               ...
               parquet_intermediate_location / 'p2_sensors_parquet']:#,parquet_intermediate_location / 'veh_parquet']:
...
def process_traffic_data():
    ...
    other_excel_files = [f for f in excel_files if f not in pedestrian_counts and f not in all_p2_sensor_files] #and f not in veh_report_files 
